...
<head>
    ...
    <!-- Favicons -->
    <link href="{{asset('estudiantes/img/favicon.png')}}" rel="icon">
    <link href="{{asset('estudiantes/img/apple-touch-icon.png')}}" rel="apple-touch-icon">
    ...
    <!-- Vendor CSS Files -->
    <link href="{{asset('estudiantes/vendor/aos/aos.css')}}" rel="stylesheet">
    <link href="{{asset('estudiantes/vendor/bootstrap/css/bootstrap.min.css')}}" rel="stylesheet">
    <link href="{{asset('estudiantes/vendor/bootstrap-icons/bootstrap-icons.css')}}" rel="stylesheet">
    <link href="{{asset('estudiantes/vendor/glightbox/css/glightbox.min.css')}}" rel="stylesheet">
    <link href="{{asset('estudiantes/vendor/swiper/swiper-bundle.min.css')}}" rel="stylesheet">

    <!-- Template Main CSS File -->
    <link href="{{asset('estudiantes/css/style.css')}}" rel="stylesheet">
    @yield('css')
...
<body>
                            ...
                            <div class="portfolio-info">
                                ...
                                <div>
                                    <a href="assets/img/portfolio/app1.jpg" data-gallery="portfolioGallery"
                                        title="App 1" class="portfolio-lightbox link-preview"><i
    ...
    <!-- Vendor JS Files -->
    <script src="{{asset('estudiantes/vendor/purecounter/purecounter_vanilla.js')}}"></script>
    <script src="{{asset('estudiantes/vendor/aos/aos.js')}}"></script>
    <script src="{{asset('estudiantes/vendor/bootstrap/js/bootstrap.bundle.min.js')}}"></script>
    <script src="{{asset('estudiantes/vendor/glightbox/js/glightbox.min.js')}}"></script>
    <script src="{{asset('estudiantes/vendor/isotope-layout/isotope.pkgd.min.js')}}"></script>
    <script src="{{asset('estudiantes/vendor/swiper/swiper-bundle.min.js')}}"></script>
    <script src="{{asset('estudiantes/vendor/php-email-form/validate.js')}}"></script>

    <!-- Template Main JS File -->
    <script src="{{asset('estudiantes/js/main.js')}}"></script>
    @yield('css')
