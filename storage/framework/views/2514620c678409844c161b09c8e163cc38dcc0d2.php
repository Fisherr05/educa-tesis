                    ...
                    <div class="table-responsive">
                        <table class="table table-striped ">
                            ...
                            <tbody>
                                ...
                                <td>
                                    <?php if(isset($row->url_imagen)): ?>
                                    <img src="<?php echo e(Storage::url($row->url_imagen)); ?>" alt="" width="80" height="80">
                                    <?php endif; ?>
                                </td>
                                <td><?php echo e(Str::limit($row->url_video,50)); ?></td>
                                ...
                                <td>
                                    ...
                                    <a class="btn btn-danger" data-toggle="tooltip" data-placement="bottom"
                                        ...
                                        wire:click="destroy(<?php echo e($row->id); ?>)"><i class="fa fa-trash"></i></a>
