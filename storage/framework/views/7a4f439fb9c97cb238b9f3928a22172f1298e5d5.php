...
<body id="home" data-spy="scroll" data-target="#navbar-wd" data-offset="98">
    ...
    <div id="preloader">
        <div class="loader">
            <img src="<?php echo e(asset('main/images/loader.gif')); ?>" alt="Preloader Image" />
        </div>
    </div>
    <!-- END LOADER -->
    ...
    <?php echo $__env->make('main.layouts.banner-photo', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>;
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="tab_menu">
                        <ul>
                            <li><a href="#contacto"><span class="icon"><img src="<?php echo e(asset('main/images/i1.png')); ?>"
                                            alt="#" /></span><span>Historia</span></a></li>
                            <li><a href="#contacto"><span class="icon"><img src="<?php echo e(asset('main/images/i2.png')); ?>"
                                            alt="#" /></span><span>Educación</span></a></li>
                            <li><a href="#contacto"><span class="icon"><img src="<?php echo e(asset('main/images/i3.png')); ?>"
                                            alt="#" /></span><span>Deporte</span></a></li>
                            <li><a href="#contacto"><span class="icon"><img src="<?php echo e(asset('main/images/i4.png')); ?>"
                                            alt="#" /></span><span>Social</span></a></li>
                            <li><a href="#contacto"><span class="icon"><img src="<?php echo e(asset('main/images/i5.png')); ?>"
                                            alt="#" /></span><span>Ubícanos</span></a></li>
                            <li><a href="#contacto"><span class="icon" id="correo"><img
                                            src="<?php echo e(asset('main/images/i6.png')); ?>"
                                            alt="#" /></span><span>Correo</span></a></li>
                            <li><a href="#contacto"><span class="icon"><img src="<?php echo e(asset('main/images/i7.png')); ?>"
            ...
            <div class="row">
                <div class="col-md-6 layout_padding_2">
                    <div class="full">
                        ...
                        <div class="full">
                            <a class="hvr-radial-out button-theme" href="<?php echo e(url('/info')); ?>">Saber más</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="full">
                        <img src="<?php echo e(asset('main/images/res01.JPG')); ?>" alt="#" />
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="full blog_img_popular">
                        <img class="img-responsive" src="<?php echo e(asset('main/images/mision.png')); ?>" alt="#" />
                        <a href="<?php echo e(url('/info')); ?>">
                            <h4>Misión</h4>
                        </a>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="full blog_img_popular">
                        <img class="img-responsive" src="<?php echo e(asset('main/images/vision.png')); ?>" alt="#" />
                        <a href="<?php echo e(url('/info')); ?>">
                            <h4>Visión</h4>
                        </a>
                    </div>
                ...
                <div class="col-md-4">
                    <div class="full blog_img_popular">
                        <img class="img-responsive" src="<?php echo e(asset('main/images/historia.jpg')); ?>" alt="#" />
                        <a href="<?php echo e(url('/unidadeducativa')); ?>">
                            <h4>Historia</h4>
                        </a>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="full float-right_img">
                        <img src="<?php echo e(asset('main/images/informacion.jpg')); ?>" alt="#" />
                    </div>
                </div>
                <div class="col-md-6 layout_padding_2">
                    <div class="full">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="full">
                        ...
                        <div class="full">
                            <a class="hvr-radial-out button-theme" href="<?php echo e(url('/unidadeducativa')); ?>">Ver más</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                            ...
                            <div class="carousel-item active">
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="full blog_img_popular">
                                            <img class="img-responsive" src="<?php echo e(asset('main/images/maestra.png')); ?>"
                                                alt="#" />
    ...
    <?php echo $__env->make('main.layouts.imports-scripts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php if(session('usuarioPendiente')): ?>
    <script>
        toastr["success"]("<?php echo session('usuarioPendiente'); ?>")
...
<?php echo $__env->make('main.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/educa-tesis/resources/views/main/index.blade.php ENDPATH**/ ?>