    ...
    <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">
        <?php if(config('adminlte.usermenu_image')): ?>
            <img src="<?php echo e(Auth::user()->adminlte_image()); ?>"
                 ...
                 alt="<?php echo e(Auth::user()->nombres); ?> <?php echo e(Auth::user()->apellidos); ?>">
        <?php endif; ?>
            ...
            <li class="user-header <?php echo e(config('adminlte.usermenu_header_class', 'bg-primary')); ?>
                ...
                <?php if(config('adminlte.usermenu_image')): ?>
                    <img src="<?php echo e(Auth::user()->adminlte_image()); ?>"
                         ...
                         alt="<?php echo e(Auth::user()->nombres); ?>">
                <?php endif; ?>
...
<?php /**PATH /opt/lampp/htdocs/educa-tesis/resources/views/vendor/adminlte/partials/navbar/menu-item-dropdown-user-menu.blade.php ENDPATH**/ ?>