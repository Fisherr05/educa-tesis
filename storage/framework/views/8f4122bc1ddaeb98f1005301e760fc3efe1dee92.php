...
<script>
    document.addEventListener('livewire:load',function(){
        ...
        nivel.on('change',function(){
            window.livewire.find('<?php echo e($_instance->id); ?>').set('niveles_selected',$(this).val());
        });
    });
</script>
<?php $__env->stopPush(); ?>
<?php /**PATH /opt/lampp/htdocs/educa-tesis/resources/views/livewire/docentes/create.blade.php ENDPATH**/ ?>